...
public class Animation {
    ...
    public void Draw(Canvas canvas)
    {
        ...
        //TODO 7eyd ; li 9bel w lcommentaire li moraha
        	//canvas.drawImage(animImage, x, y, x + frameWidth, y + frameHeight, startingXOfFrameInImage, 0, endingXOfFrameInImage, frameHeight, null);
    }
}
